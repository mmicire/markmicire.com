...
<style>
  :root {
    ...
    /* Column widths */
    --three-left: 120px; /* label */
    --three-mid: 555px;  /* main */
    ...
    --bg: #ffffff;
    --fg: #111111;
    --muted: #6b7280;      /* subtle text (meta) */
    --border: #e5e7eb;     /* dividers */
    --link: #0645ad;       /* accessible blue */
    --link-hover: #0b5bd3;
    --chev: #555555;       /* details chevron */
  }
  ...
  .line-meta { grid-column: 3; text-align: right; justify-self: end; font-style: italic; color: var(--muted); }
  ...
  details.fold { grid-column: 2 / -1; margin-top: 6px; border-left: 2px solid var(--border); padding-left: 10px; }
  ...
  .fold-item {
    display: grid;
    grid-template-columns: minmax(0, 1fr) auto; /* meta column hides if absent */
    column-gap: 8px;
    align-items: start;
    margin-top: 6px;
  }
  ...
  .fold-item .fold-meta { text-align: right; white-space: nowrap; margin-left: 8px; color: var(--muted); }

  /* Lists inside hidden rows */
  ...
  @media (prefers-color-scheme: dark){
    :root{
      ...
      --muted: #9aa3af;   /* cool gray for meta */
      --border: #2a2f3a;  /* subtle divider */
      --link: #8ab4f8;    /* accessible blue */
      --link-hover: #a8c7fa;
      --chev: #cbd5e1;
    }
    /* optional: quiet the left label slightly in dark mode */
    .label { color: #d1d5db; }
  }

  /* PRINT: show only what's currently expanded */
  @media print{
    :root {
      --space-before-title: 0;
      --space-after-title: 10px;
      --print-font-size: 10.0pt;
      --three-left: 100px;  /* was 110px */
      --three-mid: 575px;   /* keep or bump if needed */
  
    }
    html, body { font-size: var(--print-font-size); line-height: 1.35; }
    
    .entry { break-inside: auto; page-break-inside: auto; } /* allow entries to split across pages */
    .desc, .line-main, .line-meta, .fold-item { break-inside: avoid; } /* still avoid awkward splits inside tiny blocks */
    details.fold{ border-left:0; padding-left:0; }
    details.fold > summary { display:none; }
    details.fold[open]  > .fold-body { display:block !important; }
    details.fold:not([open]) > .fold-body { display:none !important; }
    a{ text-decoration: none; color: black; }
    .pb { break-before: page; page-break-before: always; }     /* legacy fallback */
    .pb-after { break-after: page; page-break-after: always; } /* Force a new page AFTER this element */
    .avoid-break { break-inside: avoid; page-break-inside: avoid; } /* Keep this element together on one page (use sparingly) */
    p { orphans: 3; widows: 3; }. /* Optional: nicer paragraphs */

       
              
    /* --- Choose ONE --- */
    /* @page { size: A4; margin: 14mm 14mm 16mm; } */
    /* @page { size: 8.5in 11in; margin: 0.6in 0.6in 0.7in; } */
  }
</style>
